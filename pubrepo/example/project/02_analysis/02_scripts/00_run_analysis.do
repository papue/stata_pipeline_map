...
do "$analysis_scripts/01_construct_sample.do"
do "$analysis_scripts/02_descriptive_tables.do"
do "$analysis_scripts/03_regression_models.do"
do "$analysis_scripts/04_figures.do"
