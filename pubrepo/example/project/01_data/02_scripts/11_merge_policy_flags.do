...
use "$cleaned/panel_with_demographics.dta", clear
merge m:1 region_id year using "$cleaned/policy_flags_prepared.dta", nogen
save "$cleaned/panel_with_policies.dta", replace
